        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbarSupportedContent" id="navbarSupportedContent">
                ...
                <div class="navbar-nav d-flex align-items-center justify-content-center gap-3">
                    @auth()
                        <a href="{{route('profile.index')}}" class="profile-image d-flex align-items-center justify-content-center">
                            @if(auth('web')->user()->image)
                            <img src="{{auth('web')->user()->image}}" alt="" class="rounded-circle w-100 h-100 object-fit-contain">
                            @else
                                <i class="fa fa-user fs-4"></i>
                            @endif
                        </a>
                        <span type="button" id="login-btn" class="register-btn">نقاطي 2500</span>
                        <button type="button" id="login-btn" class="main-btn text-decoration-none">الاشعارات</button>
                    @else
                        <a href="#">
                            <img src="">
                        </a>
